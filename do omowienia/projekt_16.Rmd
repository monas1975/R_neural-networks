...
model %>%
  layer_dense(units =8192, activation = 'relu', input_shape = 28*28) %>%
  layer_dropout(rate = 0.49) %>%
   layer_dense(units =4096, activation = 'relu') %>%
  layer_dropout(rate = 0.47) %>%
...
### najczęsciej mylone były "shirt" (kat.6  na osi X) z  "t-shirt\top - kat. 0 (125)
### druga w kolejce, błednie rozpoznawana kategoria "coat"(kat. 4) mylona jest z "pullover" -kat. 2 (116)
### training: loss: 0.2007 - accuracy: 0.9235
### test: loss: 0.2242 - accuracy: 0.8894
