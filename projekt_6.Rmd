...
model %>%
  layer_dense(units =2048, activation = 'relu', input_shape = 28*28) %>%
...
### najczesciej błednie rozpoznawana kategoria jest "T-shirt\top"(kat. 0) mylona  z "shirt" -kat. 6 z    (128)


### train: loss: 0.2455 - accuracy: 0.9103
### test: 0.2489 - accuracy: 0.8833
