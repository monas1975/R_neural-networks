...
model %>%
  ...
  layer_dropout(rate = 0.29) %>%
  layer_dense(units=200,activation = 'relu') %>%
  layer_dropout(rate = 0.28) %>%
  layer_dense(units=232,activation = 'relu') %>%
...
### najczesciej błednie rozpoznawana kategoria jest "T-shirt\top"(kat. 0) mylona  z "shirt" -kat. 6 z    (114)


### train: loss: loss: 0.1669 - accuracy: 0.9737
### test: loss: 0.3039 - accuracy: 0.8992
