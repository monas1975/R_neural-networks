...
model %>%
  layer_dense(units =1024, activation = 'relu', input_shape = 28*28) %>%
...
## ## Na czerwono zaznaczono błednie rozpoznane obrazki. z poniższej wizualizacji widać, ze 3 obrazkizostały rozpoznae błednie. "Coat" został pomylony z "pullover'em", "Ankle boot" z "Sandal", a Sneaker został pomylony z sandałem.
...
### najczesciej błednie rozpoznawana kategoria   "T-shirt\top"(kat. 0) mylona jest z "shirt" -kat. 6  (151)


### train: loss: 0.1970 - accuracy: 0.9377
### test: loss: 0.2725 - accuracy: 0.8934
